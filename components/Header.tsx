        ...
        <header>
            <div className="flex flex-col md:flex-row items-center p-5 bg-gray-500/10 rounded-b-2xl">
                ...
                <div className="flex items-center space-x-5 justify-end flex-1 w-full">
                    ...
                    <Avatar name="Bryan Bayoca" round size="50" color="#0055D1" />
                </div>
            </div>

            <div className="flex items-center justify-center px-5 py-2 md:py-5">
                <p className="flex items-center p-5 text-sm font-light pr-5 py-2 px-5 shadow-xl rounded-xl w-fit bg-white italic max-w-3xl   text-[#0055D1]">
